...
/*!
 * @class RangeDataViewerComp
 * @brief Standalone component Class
 *
 */
public class RangeDataViewerComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(RangeDataViewer.component_conf);
      mgr.registerFactory(prop, new RangeDataViewer(), new RangeDataViewer());

      // Create a component
      RTObject_impl comp = mgr.createComponent("RangeDataViewer");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        RangeDataViewerComp init = new RangeDataViewerComp();
